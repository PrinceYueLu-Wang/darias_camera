...
class joystick(genpy.Message):
  _md5sum = "71f51f585b7d21a17e5851f8e46a743b"
...
float64 button_right"""
  __slots__ = ['rh_axisX','rh_axisY','lh_axisX','lh_axisY','button_up','button_down','button_left','button_right']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       rh_axisX,rh_axisY,lh_axisX,lh_axisY,button_up,button_down,button_left,button_right
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_8d().pack(_x.rh_axisX, _x.rh_axisY, _x.lh_axisX, _x.lh_axisY, _x.button_up, _x.button_down, _x.button_left, _x.button_right))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.rh_axisX, _x.rh_axisY, _x.lh_axisX, _x.lh_axisY, _x.button_up, _x.button_down, _x.button_left, _x.button_right,) = _get_struct_8d().unpack(str[start:end])
      return self
